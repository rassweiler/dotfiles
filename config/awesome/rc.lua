...
awful.screen.connect_for_each_screen(function(s)
	 ...
	 -- Create the wibox
	 s.mywibox = awful.wibar({ position = "top", screen = s, bg = theme.bg_normal, fg = theme.fg_normal, height = theme.menu_height })
...
globalkeys = gears.table.join(
	 ...
	 awful.key({ modkey,"Shift"}, "Return", function () awful.spawn(explorer) end,
	 ...
	 awful.key({ modkey, "Shift"	}, "End", awesome.quit,
		{description = "Shutdown PC", group = "awesome"}),
	 ...
	 awful.key({ modkey }, "space", function() awful.spawn("rofi -modi drun -show drun -config ~/.config/rofi/config.rasi") end,
...
client.connect_signal("focus", function(c) c.border_color = theme.border_color_active end)
client.connect_signal("unfocus", function(c) c.border_color = theme.border_color_normal end)
-- }}}
