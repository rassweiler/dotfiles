...
local SCRIPT_DIR = config_path .. "scripts/"
...
--theme.forced_height = 18
theme.wallpaper = "~/.cache/current_wallpaper.jpg"
theme.hotkeys_font = "JetBrains Mono 12"
theme.hotkeys_description_font = "JetBrains Mono 12"
theme.font = "JetBrains Mono 12"
theme.popup_bg_color = theme.bg_normal
theme.popup_border_color = theme.border_color_normal
...
systray.systray_icon_spacing = 4
...
local wallpaper_widget = require("widgets.wallpaper-widget.wallpaper")
...
local windows_vm = awful.widget.button({
	...
	buttons = {
		awful.button({}, 1, nil, function()
			awful.spawn(terminal .. "start --" .. SCRIPT_DIR .. "vm_windows.sh")
		end),
	},
})
...
awful.screen.connect_for_each_screen(function(s)
	...
	s.mywibox:setup({
		...
		{ -- Right widgets
			layout = wibox.layout.fixed.horizontal,
			vm_widget(),
			vm_widget({ script = "vm_meeting.sh", image = "meeting.svg" }),
			wallpaper_widget(),
			--mpdarc_widget,
			pacman_widget({
				interval = 700,
				...
				popup_border_color = theme.border_color_active,
				popup_height = 20,
				popup_width = 400,
			}),
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey, "Shift" }, "End", awesome.quit, { description = "Shutdown PC", group = "awesome" }),
	...
	awful.key({ modkey }, "space", function()
		awful.spawn("rofi -modi drun -show drun -config ~/.config/rofi/config.rasi")
	end, { description = "Show the Rofi Menu", group = "launcher" }),
	awful.key({ modkey }, "v", function()
		awful.spawn("virt-manager")
	end, { description = "Open Virt-Manager", group = "launcher" }),
	awful.key({}, "XF86AudioPlay", function()
		awful.util.spawn("mpc toggle")
	end, { description = "Stop MPC", group = "media" }),
	awful.key({}, "XF86AudioStop", function()
		awful.util.spawn("mpc stop")
	end, { description = "Toggle MPC", group = "media" }),
...
for i = 1, 9 do
	globalkeys = gears.table.join(
		...
		-- Toggle tag on focused client.
		awful.key({ modkey, "Control", "Shift" }, "#" .. np_map[i], function()
			if client.focus then
				local tag = client.focus.screen.tags[i]
				if tag then
					client.focus:toggle_tag(tag)
...
awful.rules.rules = {
	...
	{ rule = { class = "Jellyfin" }, properties = { tag = "  " } },
	{ rule = { class = "thunderbird" }, properties = { tag = "  " } },
	{ rule = { class = "Steam" }, properties = { tag = "  " } },
	{ rule = { class = "Lutris" }, properties = { tag = "  " } },
	{ rule = { class = "steam" }, properties = { tag = "  ", floating = false } },
	{
...
client.connect_signal("unfocus", function(c)
	c.border_color = theme.border_color_normal
end)
-- }}}
