...
local wallpaper_location = config_path .. "themes/krassweiler/wallpapers/Dracula_arch.png"
local menu_icon_location = config_path .. "themes/krassweiler/icons/wdgets/menu.svg"
...
theme.forced_height = 16
theme.wallpaper = wallpaper_location
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, bg = "#282a36", fg = "#8be9fd", height = 22 })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            layout = wibox.layout.fixed.horizontal,
            pacman_widget{interval = 700, popup_bg_color = "#44475a", popup_border_width = 1, popup_border_color = "#50fa7b", popup_height = 20, popup_width = 400},
            mykeyboardlayout,
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "space", function() awful.spawn("rofi -modi drun -show drun -config ~/.config/rofi/rofidmenu.rasi") end,
