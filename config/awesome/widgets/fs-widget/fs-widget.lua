...
config.widget_bar_color = theme.fg_normal
config.widget_onclick_bg = theme.bg_focus
config.widget_border_color = theme.border_color_normal
config.widget_background_color = theme.bg_normal

-- popup
config.popup_bg = theme.bg_normal
config.popup_border_width = 1
config.popup_border_color = theme.border_color_normal
config.popup_bar_color = theme.fg_normal
config.popup_bar_background_color = theme.bg_normal
config.popup_bar_border_color = theme.border_color_normal
